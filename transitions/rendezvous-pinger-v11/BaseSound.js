...
// Supply this from the hosting application if Freesound loading is used.
// It is intentionally not embedded in this distributable test package.
const FREESOUND_TOKEN = globalThis.FREESOUND_TOKEN ?? '';
